...
def copy_files(i:int,tautomer:str):
    ...
    final = f"E_field_{i+1}/{tautomer}/"                # Next folder
    ...
    for i,line in enumerate(geometry):
        ...
        if line.split()[0] == "atom":
            ...
            if count_atoms in constrain:
                moment_file.write('constrain_relaxation  y\n')
...
for i in range(0,100+1):
    ...
    os.chdir(folder)                                # Changes directory to current folder
    ...
    while True:
        ...
        time.sleep(300)                                                             # else, wait 5 mins
